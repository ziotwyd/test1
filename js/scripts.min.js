const listoftext = ["Making cheats since 2021.", "Making websites since 2022.", "FGuard is trash.", "1hAck on top!", "Buy 1hAck today."];
...
popupContent.addEventListener("scroll", () => {
  const _0xb65695 = popupContent.scrollHeight - popupContent.scrollTop === popupContent.clientHeight;
  if (_0xb65695) {
    bReadTOS = true;
  }
  if (!bReadTOS) {
    ...
    acceptText.style.visibility = "hidden";
